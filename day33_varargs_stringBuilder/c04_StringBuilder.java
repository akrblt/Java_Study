...
public class c04_StringBuilder {
    public static void main(String[] args) {
        ...
        System.out.println(sb1);//Ne guzel Java once tostring le string e cevirdigimiz icin String in immutable ozelligini kullanir

        System.out.println(sb1.delete(0,3));//guzel Java
        System.out.println(sb1.deleteCharAt(5));//guzelJava  boslugu sildik
    }
}
