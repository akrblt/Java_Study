...
public class C04_DoWhileLoop {
    public static void main(String[] args) {
       ...
       do {
        ...
        System.out.println(sayacPozitif+" Defa pozitif sayi girilmistir.Girilen pozitif sayilarin toplami: "+toplam);
        System.out.println("Yanlislikla girilen negatif sayi sayisi: "+sayacNegatif);
